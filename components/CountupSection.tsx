  ...
  return (
    <section className="z-100 grid grid-cols-1 gap-5 py-10 sm:grid-cols-2 lg:grid-cols-4">
      {[
        ...
        <div
          className="not-intersect:opacity-0 intersect:motion-opacity-in-0 intersect:motion-scale-in-0 format dark:format-invert flex flex-col rounded-md bg-gray-100 px-8 py-12 text-center dark:bg-gray-700"
          key={`countup-${i}`}
