...
export default function Home() {
  return (
    <section className="flex max-md:flex-col items-center text-black/80 dark:text-white bg-white dark:bg-gray-800 px-10 min-h-[100vh] max-md:text-center py-10 md:-mt-16">
      <div className="flex-1/2 flex flex-col gap-10">
        ...
        <div className="flex max-sm:flex-col gap-5 mt-4">
